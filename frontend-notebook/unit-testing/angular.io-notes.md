...
- [Service testing](https://github.com/natanbr/Notebook/wiki/unit-testing#service-testing)
  - [Outside angular](https://github.com/natanbr/Notebook/wiki/unit-testing#outside-angular)
  - [Using spy service](https://github.com/natanbr/Notebook/wiki/unit-testing#using-spy-service)
- [Angular TestBed](https://github.com/natanbr/Notebook/wiki/unit-testing#angular-testbed)
  - [Testing (services) without beforeEach()](https://github.com/natanbr/Notebook/wiki/unit-testing#testing-services-without-beforeeach)
  - [Testing HTTP services](https://github.com/natanbr/Notebook/wiki/unit-testing#testing-http-services)
- [Component Test](https://github.com/natanbr/Notebook/wiki/unit-testing#component-test)
  - [@Inputs()](https://github.com/natanbr/Notebook/wiki/unit-testing#inputs)
  - [@Outputs()](https://github.com/natanbr/Notebook/wiki/unit-testing#outputs)
  - [Component DOM testing](https://github.com/natanbr/Notebook/wiki/unit-testing#component-dom-testing)
    - [querySelector](https://github.com/natanbr/Notebook/wiki/unit-testing#querySelector)
    - [By.css()](https://github.com/natanbr/Notebook/wiki/unit-testing#bycss)
  - [change detection](https://github.com/natanbr/Notebook/wiki/change-detection)
    - [HTMLInutElement (input) value dispatchEvent()]()
  - [Component with a dependency](https://github.com/natanbr/Notebook/wiki/unit-testing#component-with-a-dependency)
  - [Component with async service](https://github.com/natanbr/Notebook/wiki/unit-testing#component-with-async-service)
    - [testing with spy](https://github.com/natanbr/Notebook/wiki/unit-testing#testing-with-spy)
    - [testing with fakeAsync()](https://github.com/natanbr/Notebook/wiki/unit-testing#testing-with-fakeasync)
    - [Async observables](https://github.com/natanbr/Notebook/wiki/unit-testing#async-observables)
    - [Async test with async()](https://github.com/natanbr/Notebook/wiki/unit-testing#async-test-with-async)
    - [Jasmine done()](https://github.com/natanbr/Notebook/wiki/unit-testing#jasmine-done)
    - [Component marble tests](https://github.com/natanbr/Notebook/wiki/unit-testing#component-marble-tests)
    - 
    - 
